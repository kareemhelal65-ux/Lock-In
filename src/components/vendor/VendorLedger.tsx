            ...
            <div className="max-w-6xl mx-auto space-y-6">
                ...
                <div className="flex justify-between items-center mb-8">
                    <div>
                        ...
                        <p className="text-cool-gray">{t.ledgerSub}</p>
                    </div>
                    <select
                        value={period}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-zinc-900 border-2 border-cool-gray/30 p-6 rounded-2xl">
                        <h3 className="font-display font-black text-xl uppercase tracking-widest mb-6">{t.peakHours}</h3>
                    ...
                    {/* Item Popularity */}
                    <div className="bg-zinc-900 border-2 border-cool-gray/30 p-6 rounded-2xl">
                        <h3 className="font-display font-black text-xl uppercase tracking-widest mb-6">{t.itemPopularity}</h3>
                        <div className="space-y-4">
                            {stats.itemPopularity.length > 0 ? stats.itemPopularity.map((item: any, i: number) => (
                                ...
                                <div className="text-cool-gray text-sm py-4">{t.noItemsSold}</div>
                            )}
                        </div>
                    </div>
                </div>
